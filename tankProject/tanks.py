...
class myTank(pygame.sprite.Sprite):
	...
	def move_right(self, tankGroup, brickGroup, ironGroup, myhome):
		...
		if pygame.sprite.spritecollide(self, tankGroup, False, None):
			self.rect = self.rect.move(self.speed*-self.direction_x, self.speed*-self.direction_y)
			#tankGroup.rect.move(tankGroup.speed*-20*self.direction_x, tankGroup.speed*-20*self.direction_y)
			# is_move = False
			#self.collide(self, tankGroup)
		# 大本营
		if pygame.sprite.collide_rect(self, myhome):
			...
			for event in pygame.event.get():
				if event.type == pygame.KEYDOWN:
					...
					if key_pressed[pygame.K_w]:
						# print('按下w 按键。。。。。。。')
						self.rect.y = other.rect.y + other.rect.height
						player1_moving = True
					elif key_pressed[pygame.K_s]:
						# print('按下s 按键。。。。。。。')
						self.rect.y = other.rect.y - self.rect.height
						player1_moving = True
					elif key_pressed[pygame.K_a]:
						# print('按下a 按键。。。。。。。')
						self.rect.x = other.rect.x + other.rect.width
						player1_moving = True
					elif key_pressed[pygame.K_d]:
						self.rect.x = other.rect.x - self.rect.width
...
class enemyTank(pygame.sprite.Sprite):
	...
	def move(self, tankGroup, brickGroup, ironGroup, myhome):
		...
		# 撞其他坦克
		if pygame.sprite.spritecollide(self, tankGroup, False, None):
			self.rect = self.rect.move(self.speed*-20*self.direction_x, self.speed*-20*self.direction_y)
